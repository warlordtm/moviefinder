...
export default function Terms() {
  return (
    <section className="terms">
      ...
      <p><span className='span'>1. Use: </span>Personal, non-commercial use only.</p>
      <p><span className='span'>2. IP: </span>Content is protected and owned by us or our providers.</p>
      <p><span className='span'>3. User Conduct: </span>Keep your actions lawful and respectful.</p>
